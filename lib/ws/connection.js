...
function handshakeWithDraft75(){
  ...
  this._req.socket.write([
    ...
    "Upgrade: WebSocket",
    "Connection: Upgrade",
    "WebSocket-Origin: "+websocket_origin(this._req, this._server),
    "WebSocket-Location: "+websocket_location(this._req, this._server),
    ("subprotocol" in this._server.options ? "WebSocket-Protocol: "+this._server.options.subprotocol : ""),
    "\r\n"
  ].join("\r\n"), "utf8");
